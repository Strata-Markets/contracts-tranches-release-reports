/**
 *  AUTO-Generated Class: 2026-02-18 00:05
 *  Implementation: https://etherscan.io/address/0x5A8d34d785B5008Cce9B9F4AAa0e445f6959CBFf#code
 */
import di from 'a-di';
...
export namespace USDeAccountingV2Errors {
...
export class USDeAccountingV2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x5A8d34d785B5008Cce9B9F4AAa0e445f6959CBFf',
    ...
    Types: TUSDeAccountingV2Types;

    $meta = {
        "class": "./0xc/eth/USDeAccountingV2/USDeAccountingV2.ts"
    }
    ...
    $call () {
        return super.$call() as IUSDeAccountingV2TxCaller;
    }
    $signed (): TOverrideReturns<IUSDeAccountingV2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IUSDeAccountingV2TxData {
        return super.$data() as IUSDeAccountingV2TxData;
    }
    $gas (): TOverrideReturns<IUSDeAccountingV2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TUSDeAccountingV2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TUSDeAccountingV2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TUSDeAccountingV2Types = {
    Events: {
...
interface IUSDeAccountingV2TxCaller {
...
interface IUSDeAccountingV2TxData {
...
type TEvents = TUSDeAccountingV2Types['Events'];
