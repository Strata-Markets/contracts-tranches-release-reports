 ...
 *  Implementation: https://etherscan.io/address/0x86E638BCF6dFC98361491Faa4c6F8edE25CD739E#code
 */
import di from 'a-di';
...
export namespace TrancheSrtV1Errors {
...
export class TrancheSrtV1 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x86E638BCF6dFC98361491Faa4c6F8edE25CD739E',
        ...
        this.storage = new TrancheSrtV1StorageReader(this.address, this.client, this.explorer);
    }

    Types: TTrancheSrtV1Types;

    $meta = {
        "class": "./0xc/eth/TrancheSrtV1/TrancheSrtV1.ts"
    }
    ...
    $call () {
        return super.$call() as ITrancheSrtV1TxCaller;
    }
    $signed (): TOverrideReturns<ITrancheSrtV1TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ITrancheSrtV1TxData {
        return super.$data() as ITrancheSrtV1TxData;
    }
    $gas (): TOverrideReturns<ITrancheSrtV1TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TTrancheSrtV1Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TTrancheSrtV1Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    declare storage: TrancheSrtV1StorageReader
}
...
export type TTrancheSrtV1Types = {
    Events: {
        Approval: {
...
class TrancheSrtV1StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface ITrancheSrtV1TxCaller {
...
type TEvents = TTrancheSrtV1Types['Events'];
