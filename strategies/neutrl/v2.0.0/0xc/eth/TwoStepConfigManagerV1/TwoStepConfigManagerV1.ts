 ...
 *  Implementation: https://etherscan.io/address/0x452F0E1BD7310e3cFb32383d7c200308E551FE8A#code
 */
import di from 'a-di';
...
export namespace TwoStepConfigManagerV1Errors {
...
export class TwoStepConfigManagerV1 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x452F0E1BD7310e3cFb32383d7c200308E551FE8A',
        ...
        this.storage = new TwoStepConfigManagerV1StorageReader(this.address, this.client, this.explorer);
    }

    Types: TTwoStepConfigManagerV1Types;

    $meta = {
        "class": "./0xc/eth/TwoStepConfigManagerV1/TwoStepConfigManagerV1.ts"
    }
    ...
    $call () {
        return super.$call() as ITwoStepConfigManagerV1TxCaller;
    }
    $signed (): TOverrideReturns<ITwoStepConfigManagerV1TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ITwoStepConfigManagerV1TxData {
        return super.$data() as ITwoStepConfigManagerV1TxData;
    }
    $gas (): TOverrideReturns<ITwoStepConfigManagerV1TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TTwoStepConfigManagerV1Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TTwoStepConfigManagerV1Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    declare storage: TwoStepConfigManagerV1StorageReader
}
...
export type TTwoStepConfigManagerV1Types = {
    Events: {
...
class TwoStepConfigManagerV1StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface ITwoStepConfigManagerV1TxCaller {
...
interface ITwoStepConfigManagerV1TxData {
...
type TEvents = TTwoStepConfigManagerV1Types['Events'];
