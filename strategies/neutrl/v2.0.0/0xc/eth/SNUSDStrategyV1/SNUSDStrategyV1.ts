 ...
 *  Implementation: https://etherscan.io/address/0x4C8fA0DbC1B3021b518DF4476E33AEbe2c4aF269#code
 */
import di from 'a-di';
...
export namespace SNUSDStrategyV1Errors {
...
export class SNUSDStrategyV1 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x4C8fA0DbC1B3021b518DF4476E33AEbe2c4aF269',
        ...
        this.storage = new SNUSDStrategyV1StorageReader(this.address, this.client, this.explorer);
    }

    Types: TSNUSDStrategyV1Types;

    $meta = {
        "class": "./0xc/eth/SNUSDStrategyV1/SNUSDStrategyV1.ts"
    }
    ...
    $call () {
        return super.$call() as ISNUSDStrategyV1TxCaller;
    }
    $signed (): TOverrideReturns<ISNUSDStrategyV1TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ISNUSDStrategyV1TxData {
        return super.$data() as ISNUSDStrategyV1TxData;
    }
    $gas (): TOverrideReturns<ISNUSDStrategyV1TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TSNUSDStrategyV1Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TSNUSDStrategyV1Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    declare storage: SNUSDStrategyV1StorageReader
}
...
export type TSNUSDStrategyV1Types = {
    Events: {
        CooldownsChanged: {
...
class SNUSDStrategyV1StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface ISNUSDStrategyV1TxCaller {
...
interface ISNUSDStrategyV1TxData {
...
type TEvents = TSNUSDStrategyV1Types['Events'];
