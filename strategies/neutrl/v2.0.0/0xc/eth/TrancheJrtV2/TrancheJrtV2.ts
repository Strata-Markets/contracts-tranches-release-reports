 ...
 *  Implementation: https://etherscan.io/address/0x0Ea5BdF736F84949563F1Ec66c79b9c047fb8965#code
 */
import di from 'a-di';
...
export namespace TrancheJrtV2Errors {
...
export class TrancheJrtV2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x0Ea5BdF736F84949563F1Ec66c79b9c047fb8965',
        ...
        this.storage = new TrancheJrtV2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TTrancheJrtV2Types;

    $meta = {
        "class": "./0xc/eth/TrancheJrtV2/TrancheJrtV2.ts"
    }
    ...
    $call () {
        return super.$call() as ITrancheJrtV2TxCaller;
    }
    $signed (): TOverrideReturns<ITrancheJrtV2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ITrancheJrtV2TxData {
        return super.$data() as ITrancheJrtV2TxData;
    }
    $gas (): TOverrideReturns<ITrancheJrtV2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TTrancheJrtV2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TTrancheJrtV2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    declare storage: TrancheJrtV2StorageReader
}
...
export type TTrancheJrtV2Types = {
    Events: {
        Approval: {
...
class TrancheJrtV2StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface ITrancheJrtV2TxCaller {
...
type TEvents = TTrancheJrtV2Types['Events'];
