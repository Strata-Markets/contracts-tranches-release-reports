 ...
 *  Implementation: https://etherscan.io/address/0xa14009B8865C1B951511a8750E5E3d02e574db9d#code
 */
import di from 'a-di';
...
export namespace ERC20CooldownV1Errors {
...
export class ERC20CooldownV1 extends ContractBase {
    constructor(
        public address: TEth.Address = '0xa14009B8865C1B951511a8750E5E3d02e574db9d',
        ...
        this.storage = new ERC20CooldownV1StorageReader(this.address, this.client, this.explorer);
    }

    Types: TERC20CooldownV1Types;

    $meta = {
        "class": "./0xc/eth/ERC20CooldownV1/ERC20CooldownV1.ts"
    }
    ...
    $call () {
        return super.$call() as IERC20CooldownV1TxCaller;
    }
    $signed (): TOverrideReturns<IERC20CooldownV1TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC20CooldownV1TxData {
        return super.$data() as IERC20CooldownV1TxData;
    }
    $gas (): TOverrideReturns<IERC20CooldownV1TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC20CooldownV1Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC20CooldownV1Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC20CooldownV1Types = {
    Events: {
        Finalized: {
...
class ERC20CooldownV1StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface IERC20CooldownV1TxCaller {
...
interface IERC20CooldownV1TxData {
...
type TEvents = TERC20CooldownV1Types['Events'];
