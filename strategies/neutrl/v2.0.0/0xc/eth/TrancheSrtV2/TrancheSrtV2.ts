 ...
 *  Implementation: https://etherscan.io/address/0x470B9D44674b4706bAD670DaBb75ccFDa90D2743#code
 */
import di from 'a-di';
...
export namespace TrancheSrtV2Errors {
    ...
    export interface DepositRejectedByStrategy {
        type: 'DepositRejectedByStrategy'
        params: {
            tranche: TAddress
            token: TAddress
        }
    ...
    export interface RedemptionParamsMismatch {
        type: 'RedemptionParamsMismatch'
        params: {
            requested: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }
            current: { exitMode: number, exitFee: bigint, cooldownSeconds: number }
        }
    }
    ...
    export interface WithdrawalRejectedByStrategy {
        type: 'WithdrawalRejectedByStrategy'
        params: {
            tranche: TAddress
            token: TAddress
        }
    ...
    export type Error = AccessControlUnauthorizedAccount | AlreadyConfigured | DepositCapReached | DepositRejectedByStrategy | DepositsDisabled | ECDSAInvalidSignature | ECDSAInvalidSignatureLength | ECDSAInvalidSignatureS | ERC20InsufficientAllowance | ERC20InsufficientBalance | ERC20InvalidApprover | ERC20InvalidReceiver | ERC20InvalidSender | ERC20InvalidSpender | ERC2612ExpiredSignature | ERC2612InvalidSigner | ERC4626ExceededMaxDeposit | ERC4626ExceededMaxMint | ERC4626ExceededMaxRedeem | ERC4626ExceededMaxWithdraw | InvalidAccountNonce | InvalidCaller | InvalidConfigCooldown | InvalidInitialization | InvalidTranche | MinSharesViolation | NotInitializing | OwnableInvalidOwner | OwnableUnauthorizedAccount | RedemptionParamsMismatch | ReentrancyGuardReentrantCall | SafeERC20FailedOperation | Unauthorized | UnsupportedToken | WithdrawalCapReached | WithdrawalRejectedByStrategy | WithdrawalsDisabled | ZeroAddress | ZeroAmount
}

export class TrancheSrtV2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x470B9D44674b4706bAD670DaBb75ccFDa90D2743',
        ...
        this.storage = new TrancheSrtV2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TTrancheSrtV2Types;

    $meta = {
        "class": "./0xc/eth/TrancheSrtV2/TrancheSrtV2.ts"
    }

    async $constructor (deployer: TSender, useConservativeRedemptionPrice_: boolean): Promise<TxWriter> {
        throw new Error('Not implemented. Typing purpose. Use the ContractDeployer class to deploy the contract');
    }

    // 0xe1a45218
    async BPS_DENOMINATOR (): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'BPS_DENOMINATOR'));
    }
    ...
    // 0xc4309815
    async burnSharesAsFee (sender: TSender, shares: bigint, owner: TAddress): Promise<TxWriter> {
        return this.$write(this.$getAbiItem('function', 'burnSharesAsFee'), sender, shares, owner);
    }
    ...
    // 0x6cd5db52
    async deposit (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<TxWriter>
    // 0x6e553f65
    async deposit (sender: TSender, tokenAssets: bigint, receiver: TAddress): Promise<TxWriter>
    // 0xaed445c9
    async deposit (sender: TSender, tokenAssets: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<TxWriter>
    // 0xf45346dc
    async deposit (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress): Promise<TxWriter>
        async deposit (sender: TSender, ...args): Promise<TxWriter> {
            let abi = this.$getAbiItemOverload([ 'function deposit(address, uint256, address, tuple) returns uint256', 'function deposit(uint256, address) returns uint256', 'function deposit(uint256, address, tuple) returns uint256', 'function deposit(address, uint256, address) returns uint256' ], args);
    ...
    // 0x76016870
    async maxDeposit (token: TAddress, owner: TAddress): Promise<bigint>
        async maxDeposit (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload('maxDeposit', args);
            return this.$read(abi, ...args);
        }

    // 0xc63d75b6
    async maxMint (input0: TAddress): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'maxMint'), input0);
    }
    ...
    // 0x8c22e9b0
    async maxWithdraw (token: TAddress, owner: TAddress): Promise<bigint>
    // 0xce96cb77
    async maxWithdraw (owner: TAddress): Promise<bigint>
        async maxWithdraw (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload('maxWithdraw', args);
            return this.$read(abi, ...args);
        }
    ...
    // 0x30da983d
    async mint (sender: TSender, shares: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<TxWriter>
    // 0x94bf804d
    async mint (sender: TSender, shares: bigint, receiver: TAddress): Promise<TxWriter>
    // 0xfbec97ef
    async mint (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<TxWriter>
        async mint (sender: TSender, ...args): Promise<TxWriter> {
            let abi = this.$getAbiItemOverload([ 'function mint(address, uint256, address) returns uint256', 'function mint(uint256, address, tuple) returns uint256', 'function mint(uint256, address) returns uint256', 'function mint(address, uint256, address, tuple) returns uint256' ], args);
            return this.$write(abi, sender, ...args);
        }
    ...
    // 0xb8f82b26
    async previewDeposit (token: TAddress, tokenAmount: bigint): Promise<bigint>
    // 0xef8b30f7
    async previewDeposit (assetsGross: bigint): Promise<bigint>
        async previewDeposit (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload('previewDeposit', args);
            return this.$read(abi, ...args);
        }

        
    // 0xb3d7f6b9
    async previewMint (sharesNet: bigint): Promise<bigint>
    // 0xd1f810a5
    async previewMint (token: TAddress, shares: bigint): Promise<bigint>
        async previewMint (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload('previewMint', args);
            return this.$read(abi, ...args);
        }
    ...
    // 0xcbe52ae3
    async previewRedeem (token: TAddress, shares: bigint): Promise<bigint>
        async previewRedeem (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload('previewRedeem', args);
            return this.$read(abi, ...args);
        }
    ...
    // 0xbbc6f1dc
    async previewWithdraw (token: TAddress, tokenAmount: bigint): Promise<bigint>
        async previewWithdraw (...args): Promise<bigint> {
            let abi = this.$getAbiItemOverload('previewWithdraw', args);
            return this.$read(abi, ...args);
        }

    // 0xe8fa77a0
    async quoteDeposit (assetsGross: bigint, feeBps: bigint): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'quoteDeposit'), assetsGross, feeBps);
    }

    // 0xf69efc19
    async quoteMint (sharesNet: bigint, feeBps: bigint): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'quoteMint'), sharesNet, feeBps);
    }

    // 0x21d2a89d
    async quoteRedeem (sharesGross: bigint, fee: bigint): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'quoteRedeem'), sharesGross, fee);
    }

    // 0x0f4d3eaf
    async quoteWithdraw (assetsNet: bigint, fee: bigint): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'quoteWithdraw'), assetsNet, fee);
    }

        
    // 0x0c9a3678
    async redeem (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number }): Promise<TxWriter>
    // 0x464d1734
    async redeem (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<TxWriter>
    // 0x77c59782
    async redeem (sender: TSender, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<TxWriter>
    // 0xba087652
    ...
    async redeem (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress): Promise<TxWriter>
        async redeem (sender: TSender, ...args): Promise<TxWriter> {
            let abi = this.$getAbiItemOverload([ 'function redeem(address, uint256, address, address, tuple) returns uint256', 'function redeem(address, uint256, address, address, tuple) returns uint256', 'function redeem(uint256, address, address, tuple) returns uint256', 'function redeem(uint256, address, address) returns uint256', 'function redeem(address, uint256, address, address) returns uint256' ], args);
            return this.$write(abi, sender, ...args);
        }
    ...
    // 0x34a4338a
    async setValuationKeeper (sender: TSender, valuationKeeper_: TAddress): Promise<TxWriter> {
        return this.$write(this.$getAbiItem('function', 'setValuationKeeper'), sender, valuationKeeper_);
    }
    ...
    // 0xaf8d3ab6
    async totalAssetsUnprojected (): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'totalAssetsUnprojected'));
    }
    ...
    // 0xfd9ea57d
    async useConservativeRedemptionPrice (): Promise<boolean> {
        return this.$read(this.$getAbiItem('function', 'useConservativeRedemptionPrice'));
    }

    // 0x27549e30
    async valuationKeeper (): Promise<TAddress> {
        return this.$read(this.$getAbiItem('function', 'valuationKeeper'));
    }

        
    // 0x822bea13
    async withdraw (sender: TSender, assets: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<TxWriter>
    // 0xb1f2efc8
    async withdraw (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number }): Promise<TxWriter>
    // 0xb460af94
    async withdraw (sender: TSender, assets: bigint, receiver: TAddress, owner: TAddress): Promise<TxWriter>
    // 0xcce00731
    async withdraw (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<TxWriter>
    // 0xdfcd412e
    async withdraw (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress): Promise<TxWriter>
        async withdraw (sender: TSender, ...args): Promise<TxWriter> {
            let abi = this.$getAbiItemOverload([ 'function withdraw(uint256, address, address, tuple) returns uint256', 'function withdraw(address, uint256, address, address, tuple) returns uint256', 'function withdraw(uint256, address, address) returns uint256', 'function withdraw(address, uint256, address, address, tuple) returns uint256', 'function withdraw(address, uint256, address, address) returns uint256' ], args);
            return this.$write(abi, sender, ...args);
        }

    $call () {
        return super.$call() as ITrancheSrtV2TxCaller;
    }
    $signed (): TOverrideReturns<ITrancheSrtV2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ITrancheSrtV2TxData {
        return super.$data() as ITrancheSrtV2TxData;
    }
    $gas (): TOverrideReturns<ITrancheSrtV2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TTrancheSrtV2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TTrancheSrtV2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    onNewValuationKeeper (fn?: (event: TClientEventsStreamData<TEventArguments<'NewValuationKeeper'>>) => void): ClientEventsStream<TClientEventsStreamData<TEventArguments<'NewValuationKeeper'>>> {
        return this.$onLog('NewValuationKeeper', fn);
    }

    onOnExit (fn?: (event: TClientEventsStreamData<TEventArguments<'OnExit'>>) => void): ClientEventsStream<TClientEventsStreamData<TEventArguments<'OnExit'>>> {
        return this.$onLog('OnExit', fn);
    }
    ...
    extractLogsNewValuationKeeper (tx: TEth.TxReceipt): ITxLogItem<TEventParams<'NewValuationKeeper'>>[] {
        let abi = this.$getAbiItem('event', 'NewValuationKeeper');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TEventParams<'NewValuationKeeper'>>[];
    }

    extractLogsOnExit (tx: TEth.TxReceipt): ITxLogItem<TEventParams<'OnExit'>>[] {
        let abi = this.$getAbiItem('event', 'OnExit');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TEventParams<'OnExit'>>[];
    }
    ...
    async getPastLogsNewValuationKeeper (options?: {
        fromBlock?: number | Date
        toBlock?: number | Date
        params?: {  }
    }): Promise<ITxLogItem<TEventParams<'NewValuationKeeper'>>[]> {
        return await this.$getPastLogsParsed('NewValuationKeeper', options) as any;
    }

    async getPastLogsOnExit (options?: {
        fromBlock?: number | Date
        toBlock?: number | Date
        params?: { owner?: TAddress,token?: TAddress }
    }): Promise<ITxLogItem<TEventParams<'OnExit'>>[]> {
        return await this.$getPastLogsParsed('OnExit', options) as any;
    }
    ...
    async getPastLogsOnMetaWithdraw (options?: {
        fromBlock?: number | Date
        toBlock?: number | Date
        params?: { receiver?: TAddress,token?: TAddress }
    ...
    abi: TAbiItem[] = [{"inputs":[{"internalType":"bool","name":"useConservativeRedemptionPrice_","type":"bool"}],"stateMutability":"nonpayable","type":"constructor"},{"inputs":[{"internalType":"address","name":"account","type":"address"},{"internalType":"bytes32","name":"neededRole","type":"bytes32"}],"name":"AccessControlUnauthorizedAccount","type":"error"},{"inputs":[],"name":"AlreadyConfigured","type":"error"},{"inputs":[{"internalType":"address","name":"tranche","type":"address"}],"name":"DepositCapReached","type":"error"},{"inputs":[{"internalType":"address","name":"tranche","type":"address"},{"internalType":"address","name":"token","type":"address"}],"name":"DepositRejectedByStrategy","type":"error"},{"inputs":[{"internalType":"address","name":"tranche","type":"address"}],"name":"DepositsDisabled","type":"error"},{"inputs":[],"name":"ECDSAInvalidSignature","type":"error"},{"inputs":[{"internalType":"uint256","name":"length","type":"uint256"}],"name":"ECDSAInvalidSignatureLength","type":"error"},{"inputs":[{"internalType":"bytes32","name":"s","type":"bytes32"}],"name":"ECDSAInvalidSignatureS","type":"error"},{"inputs":[{"internalType":"address","name":"spender","type":"address"},{"internalType":"uint256","name":"allowance","type":"uint256"},{"internalType":"uint256","name":"needed","type":"uint256"}],"name":"ERC20InsufficientAllowance","type":"error"},{"inputs":[{"internalType":"address","name":"sender","type":"address"},{"internalType":"uint256","name":"balance","type":"uint256"},{"internalType":"uint256","name":"needed","type":"uint256"}],"name":"ERC20InsufficientBalance","type":"error"},{"inputs":[{"internalType":"address","name":"approver","type":"address"}],"name":"ERC20InvalidApprover","type":"error"},{"inputs":[{"internalType":"address","name":"receiver","type":"address"}],"name":"ERC20InvalidReceiver","type":"error"},{"inputs":[{"internalType":"address","name":"sender","type":"address"}],"name":"ERC20InvalidSender","type":"error"},{"inputs":[{"internalType":"address","name":"spender","type":"address"}],"name":"ERC20InvalidSpender","type":"error"},{"inputs":[{"internalType":"uint256","name":"deadline","type":"uint256"}],"name":"ERC2612ExpiredSignature","type":"error"},{"inputs":[{"internalType":"address","name":"signer","type":"address"},{"internalType":"address","name":"owner","type":"address"}],"name":"ERC2612InvalidSigner","type":"error"},{"inputs":[{"internalType":"address","name":"receiver","type":"address"},{"internalType":"uint256","name":"assets","type":"uint256"},{"internalType":"uint256","name":"max","type":"uint256"}],"name":"ERC4626ExceededMaxDeposit","type":"error"},{"inputs":[{"internalType":"address","name":"receiver","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"uint256","name":"max","type":"uint256"}],"name":"ERC4626ExceededMaxMint","type":"error"},{"inputs":[{"internalType":"address","name":"owner","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"uint256","name":"max","type":"uint256"}],"name":"ERC4626ExceededMaxRedeem","type":"error"},{"inputs":[{"internalType":"address","name":"owner","type":"address"},{"internalType":"uint256","name":"assets","type":"uint256"},{"internalType":"uint256","name":"max","type":"uint256"}],"name":"ERC4626ExceededMaxWithdraw","type":"error"},{"inputs":[{"internalType":"address","name":"account","type":"address"},{"internalType":"uint256","name":"currentNonce","type":"uint256"}],"name":"InvalidAccountNonce","type":"error"},{"inputs":[{"internalType":"address","name":"caller","type":"address"}],"name":"InvalidCaller","type":"error"},{"inputs":[],"name":"InvalidConfigCooldown","type":"error"},{"inputs":[],"name":"InvalidInitialization","type":"error"},{"inputs":[{"internalType":"address","name":"tranche","type":"address"}],"name":"InvalidTranche","type":"error"},{"inputs":[],"name":"MinSharesViolation","type":"error"},{"inputs":[],"name":"NotInitializing","type":"error"},{"inputs":[{"internalType":"address","name":"owner","type":"address"}],"name":"OwnableInvalidOwner","type":"error"},{"inputs":[{"internalType":"address","name":"account","type":"address"}],"name":"OwnableUnauthorizedAccount","type":"error"},{"inputs":[{"components":[{"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"internalType":"uint256","name":"exitFee","type":"uint256"},{"internalType":"uint32","name":"cooldownSeconds","type":"uint32"},{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TRedemptionParams","name":"requested","type":"tuple"},{"components":[{"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"internalType":"uint256","name":"exitFee","type":"uint256"},{"internalType":"uint32","name":"cooldownSeconds","type":"uint32"}],"internalType":"struct ITranche.TRedemptionExitParams","name":"current","type":"tuple"}],"name":"RedemptionParamsMismatch","type":"error"},{"inputs":[],"name":"ReentrancyGuardReentrantCall","type":"error"},{"inputs":[{"internalType":"address","name":"token","type":"address"}],"name":"SafeERC20FailedOperation","type":"error"},{"inputs":[{"internalType":"address","name":"sender","type":"address"},{"internalType":"address","name":"calledContract","type":"address"},{"internalType":"bytes4","name":"sel","type":"bytes4"}],"name":"Unauthorized","type":"error"},{"inputs":[{"internalType":"address","name":"token","type":"address"}],"name":"UnsupportedToken","type":"error"},{"inputs":[{"internalType":"address","name":"tranche","type":"address"}],"name":"WithdrawalCapReached","type":"error"},{"inputs":[{"internalType":"address","name":"tranche","type":"address"},{"internalType":"address","name":"token","type":"address"}],"name":"WithdrawalRejectedByStrategy","type":"error"},{"inputs":[{"internalType":"address","name":"tranche","type":"address"}],"name":"WithdrawalsDisabled","type":"error"},{"inputs":[],"name":"ZeroAddress","type":"error"},{"inputs":[],"name":"ZeroAmount","type":"error"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"owner","type":"address"},{"indexed":true,"internalType":"address","name":"spender","type":"address"},{"indexed":false,"internalType":"uint256","name":"value","type":"uint256"}],"name":"Approval","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"owner","type":"address"},{"indexed":false,"internalType":"uint256","name":"assets","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"shares","type":"uint256"}],"name":"Deposit","type":"event"},{"anonymous":false,"inputs":[],"name":"EIP712DomainChanged","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"internalType":"uint64","name":"version","type":"uint64"}],"name":"Initialized","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"internalType":"address","name":"accessControlManager","type":"address"}],"name":"NewAccessControlManager","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"internalType":"address","name":"twoStepConfigManager","type":"address"}],"name":"NewTwoStepConfigManager","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"internalType":"address","name":"valuationKeeper","type":"address"}],"name":"NewValuationKeeper","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"owner","type":"address"},{"indexed":true,"internalType":"address","name":"token","type":"address"},{"indexed":false,"internalType":"uint256","name":"tokenAssets","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"shares","type":"uint256"},{"indexed":false,"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"exitFee","type":"uint256"},{"indexed":false,"internalType":"uint32","name":"cooldownSeconds","type":"uint32"}],"name":"OnExit","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"owner","type":"address"},{"indexed":true,"internalType":"address","name":"token","type":"address"},{"indexed":false,"internalType":"uint256","name":"tokenAssets","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"shares","type":"uint256"}],"name":"OnMetaDeposit","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"receiver","type":"address"},{"indexed":true,"internalType":"address","name":"token","type":"address"},{"indexed":false,"internalType":"uint256","name":"tokenAssets","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"shares","type":"uint256"}],"name":"OnMetaWithdraw","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"previousOwner","type":"address"},{"indexed":true,"internalType":"address","name":"newOwner","type":"address"}],"name":"OwnershipTransferStarted","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"previousOwner","type":"address"},{"indexed":true,"internalType":"address","name":"newOwner","type":"address"}],"name":"OwnershipTransferred","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"from","type":"address"},{"indexed":true,"internalType":"address","name":"to","type":"address"},{"indexed":false,"internalType":"uint256","name":"value","type":"uint256"}],"name":"Transfer","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"sender","type":"address"},{"indexed":true,"internalType":"address","name":"receiver","type":"address"},{"indexed":true,"internalType":"address","name":"owner","type":"address"},{"indexed":false,"internalType":"uint256","name":"assets","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"shares","type":"uint256"}],"name":"Withdraw","type":"event"},{"inputs":[],"name":"BPS_DENOMINATOR","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"COOLDOWN_WORKER_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"DOMAIN_SEPARATOR","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"PAUSER_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"PROPOSER_CONFIG_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"RESERVE_MANAGER_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"UPDATER_CDO_APR_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"UPDATER_FEED_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"UPDATER_STRAT_CONFIG_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"acceptOwnership","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"acm","outputs":[{"internalType":"contract IAccessControlManager","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"owner","type":"address"},{"internalType":"address","name":"spender","type":"address"}],"name":"allowance","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"spender","type":"address"},{"internalType":"uint256","name":"value","type":"uint256"}],"name":"approve","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"asset","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"account","type":"address"}],"name":"balanceOf","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"owner","type":"address"}],"name":"burnSharesAsFee","outputs":[{"internalType":"uint256","name":"assets","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"cdo","outputs":[{"internalType":"contract IStrataCDO","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"configure","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"shares","type":"uint256"}],"name":"convertToAssets","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"assets","type":"uint256"}],"name":"convertToShares","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"decimals","outputs":[{"internalType":"uint8","name":"","type":"uint8"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"tokenAmount","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"components":[{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TDepositParams","name":"params","type":"tuple"}],"name":"deposit","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"tokenAssets","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"}],"name":"deposit","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"tokenAssets","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"components":[{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TDepositParams","name":"params","type":"tuple"}],"name":"deposit","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"tokenAmount","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"}],"name":"deposit","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"eip712Domain","outputs":[{"internalType":"bytes1","name":"fields","type":"bytes1"},{"internalType":"string","name":"name","type":"string"},{"internalType":"string","name":"version","type":"string"},{"internalType":"uint256","name":"chainId","type":"uint256"},{"internalType":"address","name":"verifyingContract","type":"address"},{"internalType":"bytes32","name":"salt","type":"bytes32"},{"internalType":"uint256[]","name":"extensions","type":"uint256[]"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getCDOAddress","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"owner_","type":"address"},{"internalType":"address","name":"acm_","type":"address"},{"internalType":"string","name":"name","type":"string"},{"internalType":"string","name":"symbol","type":"string"},{"internalType":"contract IERC20","name":"baseAsset","type":"address"},{"internalType":"contract IStrataCDO","name":"cdo_","type":"address"}],"name":"initialize","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"}],"name":"maxDeposit","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"address","name":"owner","type":"address"}],"name":"maxDeposit","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"}],"name":"maxMint","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"owner","type":"address"}],"name":"maxRedeem","outputs":[{"internalType":"uint256","name":"sharesGross","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"address","name":"owner","type":"address"}],"name":"maxWithdraw","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"owner","type":"address"}],"name":"maxWithdraw","outputs":[{"internalType":"uint256","name":"assetsNet","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"}],"name":"mint","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"components":[{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TDepositParams","name":"params","type":"tuple"}],"name":"mint","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"}],"name":"mint","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"components":[{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TDepositParams","name":"params","type":"tuple"}],"name":"mint","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"name","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"owner","type":"address"}],"name":"nonces","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"owner","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"pendingOwner","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"owner","type":"address"},{"internalType":"address","name":"spender","type":"address"},{"internalType":"uint256","name":"value","type":"uint256"},{"internalType":"uint256","name":"deadline","type":"uint256"},{"internalType":"uint8","name":"v","type":"uint8"},{"internalType":"bytes32","name":"r","type":"bytes32"},{"internalType":"bytes32","name":"s","type":"bytes32"}],"name":"permit","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"tokenAmount","type":"uint256"}],"name":"previewDeposit","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"assetsGross","type":"uint256"}],"name":"previewDeposit","outputs":[{"internalType":"uint256","name":"sharesNet","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"sharesNet","type":"uint256"}],"name":"previewMint","outputs":[{"internalType":"uint256","name":"assetsGross","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"}],"name":"previewMint","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"sharesGross","type":"uint256"}],"name":"previewRedeem","outputs":[{"internalType":"uint256","name":"assetsNet","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"}],"name":"previewRedeem","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"assetsNet","type":"uint256"}],"name":"previewWithdraw","outputs":[{"internalType":"uint256","name":"sharesGross","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"tokenAmount","type":"uint256"}],"name":"previewWithdraw","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"assetsGross","type":"uint256"},{"internalType":"uint256","name":"feeBps","type":"uint256"}],"name":"quoteDeposit","outputs":[{"internalType":"uint256","name":"sharesNet","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"sharesNet","type":"uint256"},{"internalType":"uint256","name":"feeBps","type":"uint256"}],"name":"quoteMint","outputs":[{"internalType":"uint256","name":"assetsGross","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"sharesGross","type":"uint256"},{"internalType":"uint256","name":"fee","type":"uint256"}],"name":"quoteRedeem","outputs":[{"internalType":"uint256","name":"assetsNet","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"assetsNet","type":"uint256"},{"internalType":"uint256","name":"fee","type":"uint256"}],"name":"quoteWithdraw","outputs":[{"internalType":"uint256","name":"sharesGross","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"},{"components":[{"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"internalType":"uint256","name":"exitFee","type":"uint256"},{"internalType":"uint32","name":"cooldownSeconds","type":"uint32"}],"internalType":"struct ITranche.TRedemptionExitParams","name":"params","type":"tuple"}],"name":"redeem","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"},{"components":[{"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"internalType":"uint256","name":"exitFee","type":"uint256"},{"internalType":"uint32","name":"cooldownSeconds","type":"uint32"},{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TRedemptionParams","name":"params","type":"tuple"}],"name":"redeem","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"},{"components":[{"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"internalType":"uint256","name":"exitFee","type":"uint256"},{"internalType":"uint32","name":"cooldownSeconds","type":"uint32"},{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TRedemptionParams","name":"params","type":"tuple"}],"name":"redeem","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"}],"name":"redeem","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"shares","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"}],"name":"redeem","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"renounceOwnership","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"accessControlManager_","type":"address"}],"name":"setAccessControlManager","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"twoStepConfigManager_","type":"address"}],"name":"setTwoStepConfigManager","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"valuationKeeper_","type":"address"}],"name":"setValuationKeeper","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"symbol","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"totalAssets","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"totalAssetsUnprojected","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"totalSupply","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"to","type":"address"},{"internalType":"uint256","name":"value","type":"uint256"}],"name":"transfer","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"from","type":"address"},{"internalType":"address","name":"to","type":"address"},{"internalType":"uint256","name":"value","type":"uint256"}],"name":"transferFrom","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"newOwner","type":"address"}],"name":"transferOwnership","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"twoStepConfigManager","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"useConservativeRedemptionPrice","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"valuationKeeper","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"assets","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"},{"components":[{"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"internalType":"uint256","name":"exitFee","type":"uint256"},{"internalType":"uint32","name":"cooldownSeconds","type":"uint32"},{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TRedemptionParams","name":"params","type":"tuple"}],"name":"withdraw","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"tokenAmount","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"},{"components":[{"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"internalType":"uint256","name":"exitFee","type":"uint256"},{"internalType":"uint32","name":"cooldownSeconds","type":"uint32"}],"internalType":"struct ITranche.TRedemptionExitParams","name":"params","type":"tuple"}],"name":"withdraw","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"uint256","name":"assets","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"}],"name":"withdraw","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"tokenAmount","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"},{"components":[{"internalType":"enum IStrataCDO.TExitMode","name":"exitMode","type":"uint8"},{"internalType":"uint256","name":"exitFee","type":"uint256"},{"internalType":"uint32","name":"cooldownSeconds","type":"uint32"},{"internalType":"bytes","name":"strategyOptions","type":"bytes"}],"internalType":"struct ITranche.TRedemptionParams","name":"params","type":"tuple"}],"name":"withdraw","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"},{"internalType":"uint256","name":"tokenAmount","type":"uint256"},{"internalType":"address","name":"receiver","type":"address"},{"internalType":"address","name":"owner","type":"address"}],"name":"withdraw","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"nonpayable","type":"function"}]

    declare storage: TrancheSrtV2StorageReader
}
...
export type TTrancheSrtV2Types = {
    Events: {
        Approval: {
        ...
        NewValuationKeeper: {
            outputParams: { valuationKeeper: TAddress },
            outputArgs:   [ valuationKeeper: TAddress ],
        }
        OnExit: {
            outputParams: { owner: TAddress, token: TAddress, tokenAssets: bigint, shares: bigint, exitMode: number, exitFee: bigint, cooldownSeconds: number },
            outputArgs:   [ owner: TAddress, token: TAddress, tokenAssets: bigint, shares: bigint, exitMode: number, exitFee: bigint, cooldownSeconds: number ],
        }
        OnMetaDeposit: {
        ...
        OnMetaWithdraw: {
            outputParams: { receiver: TAddress, token: TAddress, tokenAssets: bigint, shares: bigint },
            outputArgs:   [ receiver: TAddress, token: TAddress, tokenAssets: bigint, shares: bigint ],
        }
    ...
    Methods: {
        ...
        burnSharesAsFee: {
          method: "burnSharesAsFee"
          arguments: [ shares: bigint, owner: TAddress ]
        }
        cdo: {
          method: "cdo"
          arguments: [  ]
        ...
        deposit: {
          method: "deposit"
          arguments: [ token: TAddress, tokenAmount: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex } ] | [ tokenAssets: bigint, receiver: TAddress ] | [ tokenAssets: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex } ] | [ token: TAddress, tokenAmount: bigint, receiver: TAddress ]
        }
        eip712Domain: {
          method: "eip712Domain"
          arguments: [  ]
        ...
        maxDeposit: {
          method: "maxDeposit"
          arguments: [ input0: TAddress ] | [ token: TAddress, owner: TAddress ]
        }
        maxMint: {
          method: "maxMint"
        ...
        maxWithdraw: {
          method: "maxWithdraw"
          arguments: [ token: TAddress, owner: TAddress ] | [ owner: TAddress ]
        }
        mint: {
          method: "mint"
          arguments: [ token: TAddress, shares: bigint, receiver: TAddress ] | [ shares: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex } ] | [ shares: bigint, receiver: TAddress ] | [ token: TAddress, shares: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex } ]
        }
        name: {
          method: "name"
          arguments: [  ]
        ...
        previewDeposit: {
          ...
          arguments: [ token: TAddress, tokenAmount: bigint ] | [ assetsGross: bigint ]
        }
        previewMint: {
          method: "previewMint"
          arguments: [ sharesNet: bigint ] | [ token: TAddress, shares: bigint ]
        }
        previewRedeem: {
          method: "previewRedeem"
          arguments: [ sharesGross: bigint ] | [ token: TAddress, shares: bigint ]
        }
        previewWithdraw: {
          method: "previewWithdraw"
          arguments: [ assetsNet: bigint ] | [ token: TAddress, tokenAmount: bigint ]
        }
        quoteDeposit: {
          method: "quoteDeposit"
          arguments: [ assetsGross: bigint, feeBps: bigint ]
        }
        quoteMint: {
          method: "quoteMint"
          arguments: [ sharesNet: bigint, feeBps: bigint ]
        }
        quoteRedeem: {
          method: "quoteRedeem"
          arguments: [ sharesGross: bigint, fee: bigint ]
        }
        quoteWithdraw: {
          method: "quoteWithdraw"
          arguments: [ assetsNet: bigint, fee: bigint ]
        }
        redeem: {
          method: "redeem"
          arguments: [ token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number } ] | [ token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex } ] | [ shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex } ] | [ shares: bigint, receiver: TAddress, owner: TAddress ] | [ token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress ]
        }
        renounceOwnership: {
        ...
        setValuationKeeper: {
          method: "setValuationKeeper"
          arguments: [ valuationKeeper_: TAddress ]
        }
        symbol: {
          method: "symbol"
          arguments: [  ]
        ...
        totalAssetsUnprojected: {
          method: "totalAssetsUnprojected"
          arguments: [  ]
        }
        totalSupply: {
          method: "totalSupply"
        ...
        useConservativeRedemptionPrice: {
          method: "useConservativeRedemptionPrice"
          arguments: [  ]
        }
        valuationKeeper: {
          method: "valuationKeeper"
          arguments: [  ]
        }
        withdraw: {
          method: "withdraw"
          arguments: [ assets: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex } ] | [ token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number } ] | [ assets: bigint, receiver: TAddress, owner: TAddress ] | [ token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex } ] | [ token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress ]
        }
    }
}
...
class TrancheSrtV2StorageReader extends ContractStorageReaderBase {
    constructor(
    ...
    async valuationKeeper(): Promise<TAddress> {
        return this.$storage.get(['valuationKeeper', ]);
    }

    async __gap$(): Promise<bigint[47]> {
    ...
    async migrationBitmap(): Promise<bigint> {
        return this.$storage.get(['migrationBitmap', ]);
    }
...
interface ITrancheSrtV2TxCaller {
    ...
    burnSharesAsFee (sender: TSender, shares: bigint, owner: TAddress): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    configure (sender: TSender, ): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    deposit (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    deposit (sender: TSender, tokenAssets: bigint, receiver: TAddress): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    deposit (sender: TSender, tokenAssets: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    ...
    mint (sender: TSender, shares: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    mint (sender: TSender, shares: bigint, receiver: TAddress): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    mint (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    ...
    redeem (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    redeem (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    redeem (sender: TSender, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    ...
    setValuationKeeper (sender: TSender, valuationKeeper_: TAddress): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    ...
    withdraw (sender: TSender, assets: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    withdraw (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    ...
    withdraw (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
...
interface ITrancheSrtV2TxData {
    ...
    burnSharesAsFee (sender: TSender, shares: bigint, owner: TAddress): Promise<TEth.TxLike>
    configure (sender: TSender, ): Promise<TEth.TxLike>
    deposit (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<TEth.TxLike>
    deposit (sender: TSender, tokenAssets: bigint, receiver: TAddress): Promise<TEth.TxLike>
    deposit (sender: TSender, tokenAssets: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<TEth.TxLike>
    ...
    mint (sender: TSender, shares: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<TEth.TxLike>
    mint (sender: TSender, shares: bigint, receiver: TAddress): Promise<TEth.TxLike>
    mint (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, params: { strategyOptions: TEth.Hex }): Promise<TEth.TxLike>
    ...
    redeem (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number }): Promise<TEth.TxLike>
    redeem (sender: TSender, token: TAddress, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<TEth.TxLike>
    redeem (sender: TSender, shares: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<TEth.TxLike>
    ...
    setValuationKeeper (sender: TSender, valuationKeeper_: TAddress): Promise<TEth.TxLike>
    ...
    withdraw (sender: TSender, assets: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<TEth.TxLike>
    withdraw (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number }): Promise<TEth.TxLike>
    withdraw (sender: TSender, assets: bigint, receiver: TAddress, owner: TAddress): Promise<TEth.TxLike>
    withdraw (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress, params: { exitMode: number, exitFee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex }): Promise<TEth.TxLike>
    withdraw (sender: TSender, token: TAddress, tokenAmount: bigint, receiver: TAddress, owner: TAddress): Promise<TEth.TxLike>
}


type TEvents = TTrancheSrtV2Types['Events'];
