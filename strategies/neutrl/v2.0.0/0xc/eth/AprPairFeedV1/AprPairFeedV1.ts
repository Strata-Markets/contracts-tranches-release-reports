 ...
 *  Implementation: https://etherscan.io/address/0x80F7b35310861F0e3D73ec03C0400D6B7641EcF9#code
 */
import di from 'a-di';
...
export namespace AprPairFeedV1Errors {
...
export class AprPairFeedV1 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x80F7b35310861F0e3D73ec03C0400D6B7641EcF9',
        ...
        this.storage = new AprPairFeedV1StorageReader(this.address, this.client, this.explorer);
    }

    Types: TAprPairFeedV1Types;

    $meta = {
        "class": "./0xc/eth/AprPairFeedV1/AprPairFeedV1.ts"
    }
    ...
    $call () {
        return super.$call() as IAprPairFeedV1TxCaller;
    }
    $signed (): TOverrideReturns<IAprPairFeedV1TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IAprPairFeedV1TxData {
        return super.$data() as IAprPairFeedV1TxData;
    }
    $gas (): TOverrideReturns<IAprPairFeedV1TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TAprPairFeedV1Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TAprPairFeedV1Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TAprPairFeedV1Types = {
    Events: {
        AnswerUpdated: {
...
class AprPairFeedV1StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface IAprPairFeedV1TxCaller {
...
interface IAprPairFeedV1TxData {
...
type TEvents = TAprPairFeedV1Types['Events'];
