 ...
 *  Implementation: https://etherscan.io/address/0x1Ae1d8B39ee6EEC816681a0355c844bB150Db35F#code
 */
import di from 'a-di';
...
export namespace UnstakeCooldownV2Errors {
...
export class UnstakeCooldownV2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x1Ae1d8B39ee6EEC816681a0355c844bB150Db35F',
        ...
        this.storage = new UnstakeCooldownV2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TUnstakeCooldownV2Types;

    $meta = {
        "class": "./0xc/eth/UnstakeCooldownV2/UnstakeCooldownV2.ts"
    }
    ...
    $call () {
        return super.$call() as IUnstakeCooldownV2TxCaller;
    }
    $signed (): TOverrideReturns<IUnstakeCooldownV2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IUnstakeCooldownV2TxData {
        return super.$data() as IUnstakeCooldownV2TxData;
    }
    $gas (): TOverrideReturns<IUnstakeCooldownV2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TUnstakeCooldownV2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TUnstakeCooldownV2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TUnstakeCooldownV2Types = {
    Events: {
        Finalized: {
...
class UnstakeCooldownV2StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface IUnstakeCooldownV2TxCaller {
...
interface IUnstakeCooldownV2TxData {
...
type TEvents = TUnstakeCooldownV2Types['Events'];
