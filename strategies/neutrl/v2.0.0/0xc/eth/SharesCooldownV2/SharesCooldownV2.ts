 ...
 *  Implementation: https://etherscan.io/address/0x91d7ceD99b72029CeE91528Daa26441daFfA07dC#code
 */
import di from 'a-di';
...
export namespace SharesCooldownV2Errors {
...
export class SharesCooldownV2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x91d7ceD99b72029CeE91528Daa26441daFfA07dC',
        ...
        this.storage = new SharesCooldownV2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TSharesCooldownV2Types;

    $meta = {
        "class": "./0xc/eth/SharesCooldownV2/SharesCooldownV2.ts"
    }
    ...
    // 0x47639321
    async activeRequests (vault: TAddress, account: TAddress, input2: bigint): Promise<{ unlockAt: number, shares: bigint, token: TAddress, metaKey: TEth.Hex }> {
    ...
    // 0x19207e1f
    async finalizeRequest (sender: TSender, vault: TAddress, idx: bigint, token: TAddress, user: TAddress, strategyOptions: TEth.Hex): Promise<TxWriter> {
        return this.$write(this.$getAbiItem('function', 'finalizeRequest'), sender, vault, idx, token, user, strategyOptions);
    }

    // 0xe44d470e
    async finalizeWithFee (sender: TSender, vault: TAddress, token: TAddress, user: TAddress, i: bigint, guard: { shares: bigint, daysLeft: bigint }, strategyOptions: TEth.Hex): Promise<TxWriter> {
        return this.$write(this.$getAbiItem('function', 'finalizeWithFee'), sender, vault, token, user, i, guard, strategyOptions);
    }

    // 0x79756bfb
    async finalizeWithOverrides (sender: TSender, vault: TAddress, token: TAddress, user: TAddress, strategyOptions: TEth.Hex): Promise<TxWriter> {
        return this.$write(this.$getAbiItem('function', 'finalizeWithOverrides'), sender, vault, token, user, strategyOptions);
    }
    ...
    // 0x053bebc7
    async requestMeta (vault: TAddress, account: TAddress, key: TEth.Hex): Promise<TEth.Hex> {
        return this.$read(this.$getAbiItem('function', 'requestMeta'), vault, account, key);
    }

        
    // 0x3a58f1b6
    async requestRedeem (sender: TSender, vault: TAddress, token: TAddress, initialFrom: TAddress, to: TAddress, shares: bigint, fee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex): Promise<TxWriter>
    // 0x4aecbb52
    async requestRedeem (sender: TSender, vault: TAddress, token: TAddress, initialFrom: TAddress, to: TAddress, shares: bigint, fee: bigint, cooldownSeconds: number): Promise<TxWriter>
        async requestRedeem (sender: TSender, ...args): Promise<TxWriter> {
            let abi = this.$getAbiItemOverload([ 'function requestRedeem(address, address, address, address, uint256, uint256, uint32, bytes)', 'function requestRedeem(address, address, address, address, uint256, uint256, uint32)' ], args);
            return this.$write(abi, sender, ...args);
        }
    ...
    $call () {
        return super.$call() as ISharesCooldownV2TxCaller;
    }
    $signed (): TOverrideReturns<ISharesCooldownV2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ISharesCooldownV2TxData {
        return super.$data() as ISharesCooldownV2TxData;
    }
    $gas (): TOverrideReturns<ISharesCooldownV2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TSharesCooldownV2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TSharesCooldownV2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TSharesCooldownV2Types = {
    Events: {
        ExitFeeAccrued: {
    ...
    Methods: {
        ...
        finalizeRequest: {
          ...
          arguments: [ vault: TAddress, idx: bigint, token: TAddress, user: TAddress, strategyOptions: TEth.Hex ]
        }
        finalizeWithFee: {
          method: "finalizeWithFee"
          arguments: [ vault: TAddress, token: TAddress, user: TAddress, i: bigint, guard: { shares: bigint, daysLeft: bigint }, strategyOptions: TEth.Hex ]
        }
        finalizeWithOverrides: {
          method: "finalizeWithOverrides"
          arguments: [ vault: TAddress, token: TAddress, user: TAddress, strategyOptions: TEth.Hex ]
        }
        ...
        requestMeta: {
          method: "requestMeta"
          arguments: [ vault: TAddress, account: TAddress, key: TEth.Hex ]
        }
        requestRedeem: {
          method: "requestRedeem"
          arguments: [ vault: TAddress, token: TAddress, initialFrom: TAddress, to: TAddress, shares: bigint, fee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex ] | [ vault: TAddress, token: TAddress, initialFrom: TAddress, to: TAddress, shares: bigint, fee: bigint, cooldownSeconds: number ]
        }
...
class SharesCooldownV2StorageReader extends ContractStorageReaderBase {
    constructor(
    ...
    async activeRequests(key: TAddress): Promise<Record<string | number, { unlockAt: number, shares: bigint, token: TAddress, metaKey: TEth.Hex }[]>> {
    ...
    async requestMeta(key: TAddress): Promise<Record<string | number, Record<string | number, { strategyOptions: TEth.Hex }>>> {
        return this.$storage.get(['requestMeta', key]);
    }

    async _metaKeyNonce(key: TAddress): Promise<Record<string | number, bigint>> {
        return this.$storage.get(['_metaKeyNonce', key]);
    }
    ...
    },
    {
        ...
        "name": "activeRequests",
        "size": null,
        "type": "mapping(address => mapping(address => (uint64 unlockAt, uint192 shares, address token, bytes12 metaKey)[]))"
    },
    {
        "slot": 51,
        "position": 0,
    ...
    },
    {
        ...
        "name": "requestMeta",
        "size": null,
        "type": "mapping(address => mapping(address => mapping(bytes12 => (bytes strategyOptions))))"
    },
    {
        "slot": 54,
        "position": 0,
...
interface ISharesCooldownV2TxCaller {
    ...
    finalizeRequest (sender: TSender, vault: TAddress, idx: bigint, token: TAddress, user: TAddress, strategyOptions: TEth.Hex): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    finalizeWithFee (sender: TSender, vault: TAddress, token: TAddress, user: TAddress, i: bigint, guard: { shares: bigint, daysLeft: bigint }, strategyOptions: TEth.Hex): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    finalizeWithOverrides (sender: TSender, vault: TAddress, token: TAddress, user: TAddress, strategyOptions: TEth.Hex): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    ...
    requestRedeem (sender: TSender, vault: TAddress, token: TAddress, initialFrom: TAddress, to: TAddress, shares: bigint, fee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
...
interface ISharesCooldownV2TxData {
    ...
    finalizeRequest (sender: TSender, vault: TAddress, idx: bigint, token: TAddress, user: TAddress, strategyOptions: TEth.Hex): Promise<TEth.TxLike>
    finalizeWithFee (sender: TSender, vault: TAddress, token: TAddress, user: TAddress, i: bigint, guard: { shares: bigint, daysLeft: bigint }, strategyOptions: TEth.Hex): Promise<TEth.TxLike>
    finalizeWithOverrides (sender: TSender, vault: TAddress, token: TAddress, user: TAddress, strategyOptions: TEth.Hex): Promise<TEth.TxLike>
    ...
    requestRedeem (sender: TSender, vault: TAddress, token: TAddress, initialFrom: TAddress, to: TAddress, shares: bigint, fee: bigint, cooldownSeconds: number, strategyOptions: TEth.Hex): Promise<TEth.TxLike>
...
type TEvents = TSharesCooldownV2Types['Events'];
