/**
 *  AUTO-Generated Class: 2026-04-30 20:03
 *  Implementation: https://etherscan.io/address/0x8CabD13AF1D45404a484ab22bB65dAdF71048643#code
 */
import di from 'a-di';
...
export namespace SaturnAccountingV2Errors {
...
export class SaturnAccountingV2 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x8CabD13AF1D45404a484ab22bB65dAdF71048643',
    ...
    Types: TSaturnAccountingV2Types;

    $meta = {
        "class": "./0xc/eth/SaturnAccountingV2/SaturnAccountingV2.ts"
    }
    ...
    $call () {
        return super.$call() as ISaturnAccountingV2TxCaller;
    }
    $signed (): TOverrideReturns<ISaturnAccountingV2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ISaturnAccountingV2TxData {
        return super.$data() as ISaturnAccountingV2TxData;
    }
    $gas (): TOverrideReturns<ISaturnAccountingV2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TSaturnAccountingV2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TSaturnAccountingV2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TSaturnAccountingV2Types = {
    Events: {
...
interface ISaturnAccountingV2TxCaller {
...
interface ISaturnAccountingV2TxData {
...
type TEvents = TSaturnAccountingV2Types['Events'];
