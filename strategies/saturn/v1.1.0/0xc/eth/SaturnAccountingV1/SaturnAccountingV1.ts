 ...
 *  Implementation: https://etherscan.io/address/0x4e409d5f9867352555e99a50cee2c4a73364e5b6#code
 */
import di from 'a-di';
...
export namespace SaturnAccountingV1Errors {
...
export class SaturnAccountingV1 extends ContractBase {
    constructor(
        public address: TEth.Address = '0x4e409d5f9867352555e99a50cee2c4a73364e5b6',
    ...
    Types: TSaturnAccountingV1Types;

    $meta = {
        "class": "./0xc/eth/SaturnAccountingV1/SaturnAccountingV1.ts"
    }
    ...
    $call () {
        return super.$call() as ISaturnAccountingV1TxCaller;
    }
    $signed (): TOverrideReturns<ISaturnAccountingV1TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ISaturnAccountingV1TxData {
        return super.$data() as ISaturnAccountingV1TxData;
    }
    $gas (): TOverrideReturns<ISaturnAccountingV1TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TSaturnAccountingV1Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TSaturnAccountingV1Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TSaturnAccountingV1Types = {
    Events: {
...
interface ISaturnAccountingV1TxCaller {
...
interface ISaturnAccountingV1TxData {
...
type TEvents = TSaturnAccountingV1Types['Events'];
