/**
 *  AUTO-Generated Class: 2026-05-25 13:41
 *  Implementation: https://etherscan.io/address/0xCAF0865334EB135b8C47Fca6D9049D5EaFe19D9b#code
 */
import di from 'a-di';
...
export namespace SaturnStrategyV2Errors {
...
export class SaturnStrategyV2 extends ContractBase {
    constructor(
        ...
        this.storage = new SaturnStrategyV2StorageReader(this.address, this.client, this.explorer);
    }

    Types: TSaturnStrategyV2Types;

    $meta = {
        "class": "./0xc/eth/SaturnStrategyV2/SaturnStrategyV2.ts"
    }
    ...
    async depositFeeBps (tokenIn: TAddress): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'depositFeeBps'), tokenIn);
    }
    ...
    async withdraw (sender: TSender, tranche: TAddress, token: TAddress, tokenAmount: bigint, baseAssets: bigint, _sender: TAddress, receiver: TAddress): Promise<TxWriter>
        async withdraw (sender: TSender, ...args): Promise<TxWriter> {
            let abi = this.$getAbiItemOverload([ 'function withdraw(address, address, uint256, uint256, address, address, bool) returns uint256', 'function withdraw(address, address, uint256, uint256, address, address) returns uint256' ], args);
            return this.$write(abi, sender, ...args);
        }

    $call () {
        return super.$call() as ISaturnStrategyV2TxCaller;
    }
    $signed (): TOverrideReturns<ISaturnStrategyV2TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): ISaturnStrategyV2TxData {
        return super.$data() as ISaturnStrategyV2TxData;
    }
    $gas (): TOverrideReturns<ISaturnStrategyV2TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TSaturnStrategyV2Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TSaturnStrategyV2Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TSaturnStrategyV2Types = {
    Events: {
        CooldownsChanged: {
    ...
    Methods: {
        ...
        withdraw: {
          method: "withdraw"
          arguments: [ tranche: TAddress, token: TAddress, tokenAmount: bigint, baseAssets: bigint, _sender: TAddress, receiver: TAddress, shouldSkipCooldown: boolean ] | [ tranche: TAddress, token: TAddress, tokenAmount: bigint, baseAssets: bigint, _sender: TAddress, receiver: TAddress ]
        }
    }
}
...
class SaturnStrategyV2StorageReader extends ContractStorageReaderBase {
    constructor(
...
interface ISaturnStrategyV2TxCaller {
...
interface ISaturnStrategyV2TxData {
...
type TEvents = TSaturnStrategyV2Types['Events'];
